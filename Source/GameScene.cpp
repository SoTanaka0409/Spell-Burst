...
// 繧ｷ繝ｼ繝ｳ縺ｮ蛻晄悄蛹門・逅・
// 繝励Ξ繧､繝､繝ｼ縲∵雰繝槭ロ繝ｼ繧ｸ繝｣繝ｼ縲∝推遞ｮ繧ｪ繝悶ず繧ｧ繧ｯ繝育ｮ｡逅・け繝ｩ繧ｹ縺ｮ繧､繝ｳ繧ｹ繧ｿ繝ｳ繧ｹ繧堤函謌舌・蛻晄悄蛹悶＠縺ｾ縺吶・
...
// ESC繧ｭ繝ｼ縺ｫ繧医ｋ繝昴・繧ｺ讖溯・縺ｮ蜃ｦ逅・√♀繧医・繧ｲ繝ｼ繝荳ｭ縺ｧ縺ゅｌ縺ｰ蜈ｨ繧ｪ繝悶ず繧ｧ繧ｯ繝医ｄ謨ｵ縺ｮ蜃ｺ迴ｾ繧呈峩譁ｰ縺励∪縺吶・
void GameScene::Update() {
    if (m_cutinTimer > 0) {
        m_cutinTimer--;
        return; // 譎る俣蛛懈ｭ｢・√が繝悶ず繧ｧ繧ｯ繝医ｄ謨ｵ縺ｮ譖ｴ譁ｰ繧定｡後ｏ縺ｪ縺・
    }
...
// 豈弱ヵ繝ｬ繝ｼ繝蜻ｼ縺ｰ繧後ｋ謠冗判蜃ｦ逅・
// 閭梧勹逕ｻ蜒上√ご繝ｼ繝蜀・・蜈ｨ繧ｪ繝悶ず繧ｧ繧ｯ繝医？UD・医・繝ｬ繧､繝､繝ｼ縺ｮHP繧・Ξ繝吶Ν縲∫ｵ碁ｨ灘､繝舌・縺ｪ縺ｩ・峨ｒ謠冗判縺励∪縺吶・
void GameScene::Draw() {
...
// 繧ｷ繝ｼ繝ｳ邨ゆｺ・凾縺ｮ蜃ｦ逅・
// 繧ｷ繝ｼ繝ｳ蛻・ｊ譖ｿ縺域凾縺ｪ縺ｩ縺ｫ蜻ｼ縺ｰ繧後∝虚逧・↓遒ｺ菫昴＠縺溘Γ繝｢繝ｪ・域雰繝槭ロ繝ｼ繧ｸ繝｣繝ｼ縺ｪ縺ｩ・峨ｒ隗｣謾ｾ縺励∪縺吶・
