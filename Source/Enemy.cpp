...
void Enemy::Update()
{
    Character::Update(); // 郢ｧ・ｹ郢ｧ・ｿ郢晢ｽｳ隴弱ｋ菫｣邵ｺ・ｮ雋ょｸ幢ｽｰ莉｣竊醍ｸｺ・ｩ

    if (stun_timer_ > 0) return; // 郢ｧ・ｹ郢ｧ・ｿ郢晢ｽｳ闕ｳ・ｭ邵ｺ・ｯ髯ｦ謔溯劒闕ｳ蟠弱・
...
{
    // 繝励Ξ繧､繝､繝ｼ縺ｮ蠑ｾ蛛ｴ縺ｮOnTrigger縺ｧ閾ｪ霄ｫ縺ｸ縺ｮ繝繝｡繝ｼ繧ｸ蜃ｦ逅・′陦後ｏ繧後ｋ縺溘ａ縲・
    // 縺薙％縺ｧ蠑ｾ縺ｮ遞ｮ鬘槭ｒ蛻､螳壹＠縺ｦ繝繝｡繝ｼ繧ｸ繧貞女縺代ｋ蜃ｦ逅・・荳崎ｦ√↓縺ｪ繧翫∪縺励◆縲・
}
